...
#ifndef BARQ_NATIVE_NETWORKING_WEBSOCKET_HPP
#define BARQ_NATIVE_NETWORKING_WEBSOCKET_HPP
...
namespace barq::native::networking {
    ...
    using status = ::barq::native::internal::bridge::status;
    ...
    private:
        void initialize();
        std::shared_ptr<::barq::sync::SyncSocketProvider> m_provider;
    };
}

#endif //BARQ_NATIVE_NETWORKING_WEBSOCKET_HPP
