...
#ifndef BARQ_NATIVE_BRIDGE_OBJ_HPP
#define BARQ_NATIVE_BRIDGE_OBJ_HPP
...
namespace barq::native::internal::bridge {
        ...
        void set_list_values(const col_key& col_key, const std::vector<ValueType>& values) {
            ...
            for (auto v : values) {
                if constexpr (std::is_pointer_v<ValueType>) {
                    ...
                    v2.push_back(::barq::native::serialize(v));
                }
            }
    ...
    private:
        std::reference_wrapper<barq> m_barq;
    };
...
#endif //BARQ_NATIVE_BRIDGE_OBJ_HPP
