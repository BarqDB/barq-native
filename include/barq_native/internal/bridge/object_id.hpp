...
#ifndef BARQ_NATIVE_BRIDGE_OBJECT_ID_HPP
#define BARQ_NATIVE_BRIDGE_OBJECT_ID_HPP
...
namespace barq::native::internal::bridge {
    struct object_id {
        ...
        object_id(const struct ::barq::native::object_id&); //NOLINT(google-explicit-constructor);
        operator ObjectId() const; //NOLINT(google-explicit-constructor);
        operator ::barq::native::object_id() const; //NOLINT(google-explicit-constructor);
...
#endif //BARQ_NATIVE_BRIDGE_OBJECT_ID_HPP
