...
#ifndef BARQ_NATIVE_BRIDGE_OBJECT_HPP
#define BARQ_NATIVE_BRIDGE_OBJECT_HPP
...
namespace barq::native::internal::bridge {
    ...
    struct object {
        ...
        object(const barq &barq, const obj &obj); //NOLINT(google-explicit-constructor)
        object(const barq &barq, const obj_link& link);
...
#endif //BARQ_NATIVE_BRIDGE_OBJECT_HPP
