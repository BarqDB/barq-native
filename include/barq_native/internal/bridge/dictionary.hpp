...
#ifndef BARQ_NATIVE_BRIDGE_DICTIONARY_HPP
#define BARQ_NATIVE_BRIDGE_DICTIONARY_HPP
...
namespace barq::native::internal::bridge {
    ...
    using CoreDictionary = ::barq::CoreDictionary;
...
#endif //BARQ_NATIVE_BRIDGE_DICTIONARY_HPP
