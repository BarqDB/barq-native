...
#ifndef BARQ_NATIVE_BRIDGE_LIST_HPP
#define BARQ_NATIVE_BRIDGE_LIST_HPP
...
namespace barq::native::internal::bridge {
    ...
    struct list {
        ...
        list(const barq& barq, const obj& obj, const col_key&);
    ...
    private:
        ...
        inline ::barq::List* get_list();
        inline const ::barq::List* get_list() const;
#ifdef BARQ_NATIVE_HAVE_GENERATED_BRIDGE_TYPES
        storage::List m_list[1];
#else
        std::shared_ptr<::barq::List> m_list;
#endif
    };
...
#endif //BARQ_NATIVE_BRIDGE_LIST_HPP
