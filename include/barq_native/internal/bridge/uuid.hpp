...
#ifndef BARQ_NATIVE_BRIDGE_UUID_HPP
#define BARQ_NATIVE_BRIDGE_UUID_HPP
...
namespace barq::native::internal::bridge {
    struct uuid {
        ...
        uuid(const struct ::barq::native::uuid&); //NOLINT(google-explicit-constructor);
        operator UUID() const; //NOLINT(google-explicit-constructor);
        operator ::barq::native::uuid() const; //NOLINT(google-explicit-constructor);
...
#endif //BARQ_NATIVE_BRIDGE_UUID_HPP
