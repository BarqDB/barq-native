...
#ifndef BARQ_NATIVE_BRIDGE_SYNC_SESSION_HPP
#define BARQ_NATIVE_BRIDGE_SYNC_SESSION_HPP
...
namespace barq::native::internal::bridge {
        ...
        struct sync_session {
            ...
            The session will not attempt to connect to Barq Sync until `resume`
            is called or the Barq file is closed and re-opened.
             */
            void pause();

            /**
            Resume syncronization and reconnect to Barq Sync after suspending.
            ...
            Barq automatically reconnects after disconnects with an exponential backoff,
...
#endif //BARQ_NATIVE_BRIDGE_SYNC_SESSION_HPP
