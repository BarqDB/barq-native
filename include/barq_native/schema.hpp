...
#ifndef BARQ_NATIVE_SCHEMA_HPP
#define BARQ_NATIVE_SCHEMA_HPP
    ...
    namespace schemagen {
        ...
        struct property {
            ...
            operator internal::bridge::property() const {
                ...
                if constexpr (barq::native::internal::type_info::is_vector<Result>::value) {
                ...
                } else if constexpr (barq::native::internal::type_info::is_set<Result>::value) {
                    if constexpr (std::is_pointer_v<typename Result::value_type>) {
                        property.set_object_link(managed<std::remove_pointer_t<typename Result::value_type>, void>::schema.name);
                    }
                } else if constexpr (barq::native::internal::type_info::is_map<Result>::value) {
        ...
        struct schema {
            ...
            property_value_for_name(std::string_view property_name, const managed<Class, void> &cls, P &property, bool excluding_collections = true) const {
                bool is_array = barq::native::internal::bridge::property_has_flag(property.type, barq::native::internal::bridge::property::type::Array);
                bool is_dictionary = barq::native::internal::bridge::property_has_flag(property.type, barq::native::internal::bridge::property::type::Dictionary);
                bool is_set = barq::native::internal::bridge::property_has_flag(property.type, barq::native::internal::bridge::property::type::Set);
