...
#ifndef BARQ_NATIVE_MANAGED_PRIMARY_KEY_HPP
#define BARQ_NATIVE_MANAGED_PRIMARY_KEY_HPP
...
namespace barq::native {
        ...
        template<>
        struct managed<primary_key<barq::native::uuid>> : managed_base {
            primary_key<barq::native::uuid> detach() const {
                return operator barq::native::uuid();
            }

            operator barq::native::uuid() const {
                return m_obj->template get<internal::bridge::uuid>(m_key).operator ::barq::native::uuid();
            }
        ...
        template<>
        struct managed<primary_key<barq::native::object_id>> final : managed_base {
            primary_key<barq::native::object_id> detach() const {
                return operator barq::native::object_id();
            }

            operator barq::native::object_id() const {
                return m_obj->template get<internal::bridge::object_id>(m_key).operator ::barq::native::object_id();
            }
        ...
        template<>
        struct managed<primary_key<std::optional<barq::native::uuid>>> final : managed_base {
            primary_key<std::optional<barq::native::uuid>> detach() const {
                return operator std::optional<barq::native::uuid>();
            }

            operator std::optional<barq::native::uuid>() const {
        ...
        template<>
        struct managed<primary_key<std::optional<barq::native::object_id>>> final : managed_base {
            std::optional<barq::native::object_id> detach() const {
                return operator std::optional<barq::native::object_id>();
            }

            operator std::optional<barq::native::object_id>() const {
...
#endif //BARQ_NATIVE_MANAGED_PRIMARY_KEY_HPP
