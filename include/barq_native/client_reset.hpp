...
#ifndef BARQ_NATIVE_CLIENT_RESET_HPP
#define BARQ_NATIVE_CLIENT_RESET_HPP
...
namespace barq::native {
    ...
    namespace client_reset {
        ...
        ///
        /// - parameter before: A callback which passes a frozen copy of the local Barq state prior to client reset.
        /// - parameter after: A callback which passes a frozen copy of the local Barq and a live instance of the remote Barq after client reset.
        ...
        /// The client device will download a barq which reflects the latest
        ...
        /// The client device will download a barq with objects reflecting the latest version of the server. A recovery
...
#endif//BARQ_NATIVE_CLIENT_RESET_HPP
