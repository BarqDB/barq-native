...
#ifndef BARQ_NATIVE_TYPES_HPP
#define BARQ_NATIVE_TYPES_HPP
...
#include <barq_native/internal/type_info.hpp>
...
namespace barq::native {
    ...
    static inline int64_t serialize(int64_t v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline std::optional<int64_t> serialize(const std::optional<int64_t>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline double serialize(const double& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline std::optional<double> serialize(const std::optional<double>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline std::optional<bool> serialize(std::optional<bool> v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    template<typename T>
    static inline typename std::enable_if_t<std::is_enum_v<T>, int64_t> serialize(const T& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
    ...
    template<typename T>
    static inline std::enable_if_t<std::is_enum_v<typename T::value_type>, std::optional<int64_t>> serialize(const T& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        if (v) {
            return static_cast<int64_t>(*v);
        } else {
            return std::nullopt;
    ...
    static inline std::string serialize(const std::string& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline std::optional<std::string> serialize(const std::optional<std::string>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline internal::bridge::uuid serialize(const uuid& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    static inline uuid deserialize(const internal::bridge::uuid& v) {
        return v.operator ::barq::native::uuid();
    }

    static inline std::optional<internal::bridge::uuid> serialize(const std::optional<uuid>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline internal::bridge::binary serialize(const std::vector<uint8_t>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline std::optional<internal::bridge::binary> serialize(const std::optional<std::vector<uint8_t>>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline internal::bridge::timestamp serialize(const std::chrono::time_point<std::chrono::system_clock>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline std::optional<internal::bridge::timestamp> serialize(const std::optional<std::chrono::time_point<std::chrono::system_clock>>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    ...
    static inline internal::bridge::object_id serialize(const barq::native::object_id& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    static inline barq::native::object_id deserialize(const internal::bridge::object_id& v) {
        return v.operator ::barq::native::object_id();
    }

    static inline std::optional<internal::bridge::object_id> serialize(const std::optional<barq::native::object_id>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    static inline std::optional<barq::native::object_id> deserialize(const std::optional<internal::bridge::object_id>& v) {
        if (v) {
            return v->operator ::barq::native::object_id();
        } else {
            return std::nullopt;
    ...
    static inline internal::bridge::decimal128 serialize(const barq::native::decimal128& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    static inline barq::native::decimal128 deserialize(const internal::bridge::decimal128& v) {
        return v.operator ::barq::native::decimal128();
    }

    static inline std::optional<internal::bridge::decimal128> serialize(const std::optional<barq::native::decimal128>& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
        return v;
    }
    static inline std::optional<barq::native::decimal128> deserialize(const std::optional<internal::bridge::decimal128>& v) {
        if (v) {
            return v->operator ::barq::native::decimal128();
        } else {
            return std::nullopt;
    ...
    template <typename T>
    static inline typename std::enable_if_t<internal::type_info::MixedPersistableConcept<T>::value, internal::bridge::mixed> serialize(const T& v, const std::optional<internal::bridge::barq>& = std::nullopt) {
    ...
    deserialize(const internal::bridge::mixed& value) {
        ...
        } else if constexpr (std::is_same_v<T, barq::native::uuid>) {
            return value.operator internal::bridge::uuid().operator ::barq::native::uuid();
        } else if constexpr (std::is_same_v<T, barq::native::object_id>) {
            return value.operator internal::bridge::object_id().operator ::barq::native::object_id();
        } else if constexpr (std::is_same_v<T, barq::native::decimal128>) {
            return value.operator internal::bridge::decimal128() .operator ::barq::native::decimal128();
