...
/**
 A token which is returned from methods which subscribe to changes to a `barq::object`.
 */
...
// MARK: PropertyChange
/**
 Information about a specific property which changed in an `barq::object` change notification.
 */
template <typename T>
