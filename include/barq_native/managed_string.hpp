...
#ifndef BARQ_NATIVE_MANAGED_STRING_HPP
#define BARQ_NATIVE_MANAGED_STRING_HPP
...
namespace barq::native {
    ...
    private:
        ...
        template <typename, typename> friend struct barq::native::managed;
...
#endif //BARQ_NATIVE_MANAGED_STRING_HPP
