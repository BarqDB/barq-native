...
#include <barq_native/internal/bridge/binary.hpp>
...
#include <barq_native/internal/bridge/timestamp.hpp>
...
#define __generate_query_operator_mixed(op) \
    query &query::op(col_key column_key, mixed value, bool) { \
        this->operator=(get_query()->op(column_key, value.operator ::barq::Mixed())); \
        return *this; \
    }
namespace barq::native::internal::bridge {
    ...
    query subexpr::equal(const std::optional<int64_t>& rhs) const {
        return *std::dynamic_pointer_cast<::barq::Columns<Int>>(m_subexpr) == rhs;
    }
    ...
    query subexpr::equal(const std::optional<bool>& rhs) const {
        return *std::dynamic_pointer_cast<::barq::Columns<Bool>>(m_subexpr) == rhs;
    }
    ...
    query subexpr::equal(const std::optional<binary>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<BinaryData>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<BinaryData>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::equal(const std::optional<timestamp>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<Timestamp>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<Timestamp>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::equal(const std::optional<uuid>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<UUID>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<UUID>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::equal(const std::optional<object_id>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<ObjectId>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<ObjectId>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::equal(const std::optional<decimal128>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<Decimal128>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<Decimal128>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::equal(const std::optional<std::string>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<StringData>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<StringData>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::contains(const std::optional<std::string>& rhs, bool case_sensitive) const {
        return std::dynamic_pointer_cast<::barq::Columns<StringData>>(m_subexpr)->contains(rhs, case_sensitive);
    }

    // MIXED
    query subexpr::mixed_equal(const internal::bridge::mixed& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<Mixed>>(m_subexpr) == rhs.operator Mixed();
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<Mixed>>(m_subexpr) == ::barq::null();
        }
    }
    ...
    query subexpr::equal(const std::optional<obj>& rhs) const {
        if (rhs) {
            return *std::dynamic_pointer_cast<::barq::Columns<Link>>(m_subexpr) == *rhs;
        } else {
            return *std::dynamic_pointer_cast<::barq::Columns<Link>>(m_subexpr) != ::barq::null();
        }
    }
    ...
    template<>
    subexpr link_chain::column<::barq::native::object_id>(col_key col_name) {
        return m_link_chain->column<ObjectId>(col_name).clone();
    }

    template<>
    subexpr link_chain::column<::barq::native::uuid>(col_key col_name) {
...
#ifdef BARQ_NATIVE_HAVE_GENERATED_BRIDGE_TYPES
        *reinterpret_cast<Query *>(&m_query) = reinterpret_cast<Query *>(&m_query)->equal(column_key, ::barq::null{});
#else
        m_query = std::make_shared<Query>(m_query->equal(column_key, ::barq::null{}));
#endif
        return *this;
    }
    query& query::not_equal(col_key column_key, std::nullopt_t) {
#ifdef BARQ_NATIVE_HAVE_GENERATED_BRIDGE_TYPES
        *reinterpret_cast<Query *>(&m_query) = reinterpret_cast<Query *>(&m_query)->not_equal(column_key, ::barq::null{});
#else
        m_query = std::make_shared<Query>(m_query->not_equal(column_key, ::barq::null{}));
#endif
        return *this;
    }
