...
void test_list(Col& list, std::vector<Value> values, db& barq) {
    barq.write([&] {
...
TEST_CASE("list", "[list]") {
    ...
    SECTION("list_tests") {
        ...
        barq::native::AllTypesObjectLink o1;
        o1._id = 0;
        o1.str_col = "Fido";
        ...
        barq::native::AllTypesObjectEmbedded o2;
        o2.str_col = "Fido";
        ...
        barq.write([&managed_obj]() {
            ...
            barq::native::AllTypesObjectLink o3;
            o3._id = 1;
            o3.str_col = "Rex";
            managed_obj.list_obj_col.push_back(&o3);
            barq::native::AllTypesObjectEmbedded e;
            e.str_col = "Rex";
    ...
    SECTION("list_insert_remove_primitive") {
        ...
        CHECK(managed_obj.list_int_col.size() == 2);
        CHECK(managed_obj.list_int_col.find(1) == barq::native::not_in_collection);
    ...
    SECTION("list_insert_remove_object") {
        ...
        auto o1 = barq::native::AllTypesObjectLink();
        o1._id = 1;
        o1.str_col = "foo";
        auto o2 = barq::native::AllTypesObjectLink();
        o2._id = 2;
        o2.str_col = "bar";
        auto o3 = barq::native::AllTypesObjectLink();
        o3._id = 3;
        o3.str_col = "baz";
        auto o4 = barq::native::AllTypesObjectLink();
        o4._id = 4;
        o4.str_col = "foo baz";
        auto o5 = barq::native::AllTypesObjectLink();
        o5._id = 5;
        o5.str_col = "foo bar";
        auto o6 = barq::native::AllTypesObjectLink();
        ...
        CHECK(managed_obj.list_obj_col.size() == 4);
        auto managed_o6 = barq.write([&barq, &o6] {
            return barq.add(std::move(o6));
        });
        CHECK(managed_obj.list_obj_col.find(managed_o6) == barq::native::not_in_collection);
    ...
    SECTION("list_insert_remove_embedded_object") {
        ...
        auto o1 = barq::native::AllTypesObjectEmbedded();
        o1.str_col = "foo";
        auto o2 = barq::native::AllTypesObjectEmbedded();
        o2.str_col = "bar";
        auto o3 = barq::native::AllTypesObjectEmbedded();
        o3.str_col = "baz";
        auto o4 = barq::native::AllTypesObjectEmbedded();
        o4.str_col = "foo baz";
        auto o5 = barq::native::AllTypesObjectEmbedded();
        o5.str_col = "foo bar";
        ...
        CHECK(managed_obj.list_embedded_obj_col.size() == 4);
        CHECK(managed_obj.list_embedded_obj_col.find(managed_o5) == barq::native::not_in_collection);
    ...
    SECTION("notifications_deletions") {
        ...
        auto barq = barq::native::db(std::move(config));
        auto managed_obj = barq.write([&barq, &obj] {
            auto managed_obj = barq.add(std::move(obj));
            managed_obj.list_int_col.push_back(456);
            return managed_obj;
        });
    ...
    SECTION("list_all_primitive_types") {
        auto barq = barq::native::db(std::move(config));
        using Enum = barq::native::AllTypesObject::Enum;
        auto obj = barq.write([&]() {
            return barq.add(barq::native::AllTypesObject());
        });
        auto object_id1 = barq::native::object_id::generate();
        auto object_id2 = barq::native::object_id::generate();

        test_list(obj.list_int_col, std::vector<uint64_t>({1, 2}), barq);
        test_list(obj.list_bool_col, std::vector<uint8_t>({true, false}), barq);
        test_list(obj.list_double_col, std::vector<double>({1.23, 2.45}), barq);
        test_list(obj.list_str_col, std::vector<std::string>({"foo", "bar"}), barq);
        test_list(obj.list_enum_col, std::vector<Enum>({Enum::one, Enum::two}), barq);
        test_list(obj.list_uuid_col,
                  std::vector<barq::native::uuid>({barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120000"),
                                            barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120002")}), barq);
        test_list(obj.list_binary_col, std::vector<std::vector<uint8_t>>({{0}, {1}}), barq);
        test_list(obj.list_object_id_col, std::vector<object_id>({object_id1, object_id2}), barq);
        auto date_list_obj = barq::native::AllTypesObject();
        auto date1 = std::chrono::system_clock::now();
        auto date2 = date1 + std::chrono::hours(24);
        test_list(obj.list_date_col,
                  std::vector<std::chrono::time_point<std::chrono::system_clock>>({date1, date2}), barq);
    }
    ...
    SECTION("list_mixed") {
        ...
        barq.write([&managed_obj] {
            managed_obj.list_mixed_col.push_back(barq::native::uuid());
        });

        CHECK(std::holds_alternative<barq::native::uuid>(managed_obj.list_mixed_col[6]));
        CHECK(std::get<barq::native::uuid>(managed_obj.list_mixed_col[6]) == barq::native::uuid());
    }
    ...
    SECTION("query") {
        ...
        auto object_id1 = barq::native::object_id("000123450000ffbeef91906a");
        auto object_id2 = barq::native::object_id("000123450000ffbeef91906b");
        auto object_id3 = barq::native::object_id("000123450000ffbeef91906c");
        ...
        barq.write([&]() {
            ...
            managed_obj.list_uuid_col.push_back(barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120000"));
            managed_obj.list_uuid_col.push_back(barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120001"));
            managed_obj.list_uuid_col.push_back(barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120002"));
            ...
            managed_obj.list_mixed_col.push_back(barq::native::mixed((int64_t)1));
            managed_obj.list_mixed_col.push_back(barq::native::mixed(std::string("foo")));
            managed_obj.list_mixed_col.push_back(barq::native::mixed(date1));

            managed_obj.list_enum_col.push_back(AllTypesObject::Enum::one);
            managed_obj.list_enum_col.push_back(AllTypesObject::Enum::two);

            barq::native::AllTypesObjectEmbedded embedded1;
            embedded1.str_col = "apple";
            barq::native::AllTypesObjectEmbedded embedded2;
        ...
        auto object_results2 = managed_obj.list_obj_col.where("_id == $0", std::vector<barq::native::mixed>({barq::native::mixed((int64_t)1)}));
        CHECK(object_results2[0]._id == 1);

        auto sorted_object_results1 = managed_obj.list_obj_col.sort("str_col", true);
        auto sorted_object_results2 = managed_obj.list_obj_col.sort(std::vector<barq::native::sort_descriptor>({{"str_col", false}}));
        ...
        CHECK(sorted_object_results11[0] == barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120000"));
        CHECK(sorted_object_results11[1] == barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120001"));
        CHECK(sorted_object_results11[2] == barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120002"));

        auto sorted_object_results12 = managed_obj.list_uuid_col.sort(false);
        CHECK(sorted_object_results12[0] == barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120002"));
        CHECK(sorted_object_results12[1] == barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120001"));
        CHECK(sorted_object_results12[2] == barq::native::uuid("18de7916-7f84-11ec-a8a3-0242ac120000"));
        ...
        CHECK(sorted_object_results15[0] == barq::native::decimal128(1.23));
        CHECK(sorted_object_results15[1] == barq::native::decimal128(2.34));
        CHECK(sorted_object_results15[2] == barq::native::decimal128(3.45));

        auto sorted_object_results16 = managed_obj.list_decimal_col.sort(false);
        CHECK(sorted_object_results16[0] == barq::native::decimal128(3.45));
        CHECK(sorted_object_results16[1] == barq::native::decimal128(2.34));
        CHECK(sorted_object_results16[2] == barq::native::decimal128(1.23));
        ...
        CHECK(sorted_object_results21[0] == barq::native::mixed((int64_t)1));

        CHECK(sorted_object_results21[1] == barq::native::mixed(std::string("foo")));
        CHECK(sorted_object_results21[2] == barq::native::mixed(date1));

        auto sorted_object_results22 = managed_obj.list_mixed_col.sort(false);
        CHECK(sorted_object_results22[0] == barq::native::mixed(date1));
        CHECK(sorted_object_results22[1] == barq::native::mixed(std::string("foo")));
        CHECK(sorted_object_results22[2] == barq::native::mixed((int64_t)1));

        auto sorted_object_results23 = managed_obj.list_enum_col.sort(true);
        CHECK(sorted_object_results23[0] == AllTypesObject::Enum::one);
        CHECK(sorted_object_results23[1] == AllTypesObject::Enum::two);
    ...
    SECTION("object lifetime") {
        managed<StringObject> out_of_scope_obj;
        {
            ...
            auto managed_obj = barq.write([&] {
                return barq.add(std::move(obj1));
            });
            auto link_obj = managed_obj.list_obj_col[0];

            auto query = barq.objects<barq::native::AllTypesObject>();
            CHECK(query.size() == 1);
            size_t run_count = 0;
